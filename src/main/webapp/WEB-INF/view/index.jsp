      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="post-preview">
            <a href="">
              <h2 class="post-title">
                Slight Edge approach of thinking is the best for effective learning.
              </h2>
              <h3 class="post-subtitle">
                You should have a plan and realize it every single day
              </h3>
            </a>
          </div>
          <hr>
          <div class="post-preview">
			<a href="">
			  ...
			  <h3 class="post-subtitle">
				Passwords are stored in secured database via bcrypt algorithm.
              </h3>
			 </a>
          </div>
          <hr>
          <div class="post-preview">
            <a href="">
              <h2 class="post-title">
                Give your notes a priority.
              </h2>
              <h3 class="post-subtitle">
                It helps you find and sort it.
              </h3>
            </a>
          </div>
          <hr>
          <div class="post-preview">
            <a href="">
              <h2 class="post-title">
                You can also sort your jottings.
              </h2>
              <h3 class="post-subtitle">
                By date... by name etc...
              </h3>
